...
class LevelController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.level.list', compact('levelsList'));
    }
    ...
    {
        return view('admin.pages.level.insert');
    }
...
//        echo 'd'; die();
        return redirect()->route('levels.index')->with('notification', 'Tạo thành công');
    }
