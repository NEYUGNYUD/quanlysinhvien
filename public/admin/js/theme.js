...
(function($) {
	...
	if ( $.isFunction( $.fn[ 'dataTable' ] ) ) {
		...
		$.extend(true, $.fn.dataTable.defaults, {
			sDom: "<'row datatables-head form-inline'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'f>r><'table-responsive't><'row datatables-footer'<'col-sm-12 col-md-6'i><'col-sm-12 col-md-6'p>>",
			oLanguage: {
